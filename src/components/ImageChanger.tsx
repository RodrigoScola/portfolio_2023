...
export const ImageChanger = () => {
  ...
  const { changeStep, colors, step } = useContext(
    GlobalContext
  ...
  return (
    <>
      ...
      <div className="cursor-pointer noselect  z-40 font-bold absolute top-0 left-44 font-lato">
        ...
        <div
          id="controls"
          className=" relative left-20 top-2 lg:left-40 xl:left-80 md:left-52  md:-top-12"
        >
