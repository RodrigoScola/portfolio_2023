			...
			<LazyAnimation>
				<m.div
					animate={{
						opacity: [0, 1],
						overflow: "hidden",
						background: `linear-gradient( ${gcon.colors.backgroundColor}, ${gcon.colors.backgroundColor}`,
					}}
					transition={{ delay: 0.2 }}
				>
					<div
						className={`max-w-[1600px] min-h-screen m-auto pb-12 relative z-50 ${gcon.colors.textColor}`}
					>
